...
const PHASES = [
	{ label: "Phase 1", desc: "code-reviewer scans the diff", color: COLORS.blue },
...
export const WorkflowAgentLiveScene: React.FC = () => {
	...
	return (
		<SceneFrame accentColor={COLORS.green}>
			<Headline text="`feature-pr-gate` in Action" size="lg" delay={0} />
			...
			<div style={{ flex: 1, display: "flex", flexDirection: "column", gap: 16, marginTop: 28 }}>
				...
				>
					One invocation. Four phases. Every quality gate covered.
				</div>
			</div>
		</SceneFrame>
	);
